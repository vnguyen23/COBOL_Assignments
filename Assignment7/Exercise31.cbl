       ...
       01  Multiplication-Square.
	       03  multiplication-table occurs 10. *>vertical direction
       ...
       main-program.
           ...
           stop run.
      **********************************************************
      ***********PERFORM MULTIPLICATION FOR TABLES 1 to 10******
      **********************************************************
       ...
       display-result.    
           ...
           *>including table# at beginning of the row
           ...
           counter > 10
               ...
               *>display value of 1st vertical column which is the 
               *>table# where multiplication happens
