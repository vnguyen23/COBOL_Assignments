      ...
      **************************************************
       ...
       01 enable-esc-and-f1. *>user-key-control
           03 filler		pic 9(2) comp-x value 1. *>enable key
           03 filler		pic x value "1".         
           03 filler	    pic 9(2) comp-x value 0. *>
           03 filler   		pic 9(2) comp-x value 2. *>number-of-keys
       
       01 disable-all-other-user-keys.
           03 filler  			pic 9(2) comp-x value 0. *>disable key
           03 filler   			pic x value "1".
           03 filler  			pic 9(2) comp-x value 2. *>
           03 filler  			pic 9(2) comp-x value 126. *>num-of-keys
       
       
       01 enable-slash-key.
           03 filler  			pic 9(2) comp-x value 1. *>enable key
           *> set value to 3 so data key will be set up to act as a
           *> function key, it will terminate the ACCEPT operation.
           03 filler    		pic x value "3".
           03 filler			pic x value "/". *>
           03 filler			pic 9(2) comp-x value 1. *>num-of-keys
